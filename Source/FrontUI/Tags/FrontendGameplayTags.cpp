...
namespace FrontendGameplyTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Frontend_WidgetStack_GetMenu, "Frontend.WidgetStack.GetMenu")
	UE_DEFINE_GAMEPLAY_TAG(Frontend_WidgetStack_GetHud, "Frontend.WidgetStack.GetHud")
